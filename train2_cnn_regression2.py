...
model = models.Sequential([
    ...
    # Global average pooling replaces the huge LSTM
...
# -----------------------------
model.save("2_cnn_regression_model.keras")
print("\nModel saved as 2_cnn_regression_model.keras")